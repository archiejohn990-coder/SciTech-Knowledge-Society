...
const questionSchema = new mongoose.Schema({
  question: String, options: [String], correctIndex: Number, explanation: String, order: Number
});
...
<h2>The Promise</h2>
<p>Researchers are using nanotechnology to develop targeted cancer treatments, clean water filters, more efficient solar cells, and lighter, stronger materials for everything from cars to medical implants.</p>
...
<p>The country's islands have been isolated for millions of years, producing species found nowhere else on Earth: the tarsier, the Philippine eagle, the tamaraw, the Visayan warty pig.</p>
<h2>The Threats</h2>
<p>Deforestation is the primary driver. The Philippines has lost more than 70% of its original forest cover. Mining, agricultural expansion, and illegal logging continue to fragment habitats.</p>
...
<p>Biodiversity is not just about beautiful animals. It's about food security, medicine, clean water, and resilience against disaster.</p>
<h2>What Can Be Done</h2>
<p>Protected areas, community-based conservation, stricter law enforcement, and public education all matter. But the biggest shift needed is in how we see nature.</p>
<p class="article-end">— END —</p>
`
  },
  {
...
<p>The countries that contributed least to global emissions — the Philippines among them — often face the most severe impacts. Within every country, the poor are hit hardest.</p>
<h2>Why Framing Matters</h2>
<p>If climate change is only an environmental issue, the solution is technical. If it is a social issue, the solution is bigger: justice, equity, and a fundamental shift in how we share the planet.</p>
<h2>The Truth</h2>
...
<h2>The Promise</h2>
<p>Gene therapy has already cured certain forms of blindness and blood disorders. Researchers are working on treatments for sickle cell disease, some cancers, and genetic conditions once considered permanent.</p>
...
<p>At its deepest level, gene therapy asks us what it means to be human — and how much control we should have over the next generation.</p>
<p class="article-end">— END —</p>
`
  },
  {
...
<p>The workers most at risk are often those with the least ability to retrain: older workers, low-income communities, workers in regions already struggling economically.</p>
<h2>What Society Owes</h2>
<p>If automation creates enormous wealth, who should share in it? Education, retraining, universal basic income, and new social contracts are all on the table.</p>
<p class="article-end">— END —</p>
`
  }
];
...
const questions = [
  { question: "What is the primary purpose of Golden Rice?", options: ["To increase rice yield", "To add Vitamin A to rice", "To make rice taste sweeter", "To make rice resistant to pests"], correctIndex: 1, explanation: "Golden Rice is engineered to produce beta-carotene, the precursor of Vitamin A.", order: 1 },
  { question: "Which is the biggest threat to Philippine biodiversity?", options: ["Volcanoes", "Deforestation", "Earthquakes", "Fog"], correctIndex: 1, explanation: "The Philippines has lost more than 70% of its original forest cover.", order: 2 },
  { question: "Why is climate change considered a social issue?", options: ["It affects only rich countries", "It affects vulnerable communities the most", "It is caused by social media", "It only happens in cities"], correctIndex: 1, explanation: "The poor and vulnerable bear the worst impacts, deepening inequality.", order: 3 },
  { question: "What is the main ethical concern with gene editing in embryos?", options: ["It is too expensive", "Changes are passed to future generations", "It takes too long", "It requires surgery"], correctIndex: 1, explanation: "Editing embryos changes the human gene pool for generations.", order: 4 },
  { question: "What makes nanotechnology ethically complex?", options: ["Nanoparticles are too big", "Long-term health and environmental effects are unclear", "It cannot be used in medicine", "It is invisible to cameras"], correctIndex: 1, explanation: "Nanoparticles can cross biological barriers, but their long-term effects are still unknown.", order: 5 },
  { question: "How many megadiverse countries does the Philippines belong to?", options: ["One of the top 17", "One of the top 100", "Not on the list", "One of the top 3"], correctIndex: 0, explanation: "The Philippines is one of 17 megadiverse countries.", order: 6 },
  { question: "Why is automation a social concern?", options: ["It makes work too easy", "It displaces workers faster than they can retrain", "It only affects factory workers", "It reduces all jobs equally"], correctIndex: 1, explanation: "Automation displaces workers, often those least able to retrain.", order: 7 },
  { question: "Which best describes the GMO debate?", options: ["It is only about science", "It is only about ethics", "It is about science, ethics, health, and society together", "It is just a marketing problem"], correctIndex: 2, explanation: "The GMO debate touches science, ethics, health, economics, farmers' rights, and more.", order: 8 }
];
